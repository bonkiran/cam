...
def _batch_session_row(page, session_date: str):
    return page.locator(".cam-session-row").filter(has_text="UI U15 Mon Wed").filter(has_text=session_date)


def _private_session_row(page, session_date: str):
    return page.locator(".cam-session-row").filter(has_text="UI Private Coach").filter(has_text=session_date)
...
def test_batches_and_sessions_ui_end_to_end():
    ...
    try:
        ...
        _json_request("PUT", "/api/cam/profile", {"name": "Batches UI Academy", "timezone": "America/New_York"})
        program = _json_request("POST", "/api/cam/programs", {"name": "UI U15 Program", "program_type": "group", "status": "active"})
        coach1 = _json_request("POST", "/api/cam/coaches", {"first_name": "UI", "last_name": "Batch Coach", "specialties": ["Batting"], "status": "active"})
        coach2 = _json_request("POST", "/api/cam/coaches", {"first_name": "UI", "last_name": "Private Coach", "specialties": ["Bowling"], "status": "active"})
        p1 = _json_request("POST", "/api/cam/players", {"name": "UI Batch Player One", "status": "active"})
        p2 = _json_request("POST", "/api/cam/players", {"name": "UI Batch Player Two", "status": "active"})
        p3 = _json_request("POST", "/api/cam/players", {"name": "UI Batch Player Three", "status": "active"})
        ...
        with sync_playwright() as playwright:
            ...
            try:
                ...
                form = page.locator("#camBatchForm")
                ...
                _wait_editor_gone(page, "#camBatchForm")
                batch_row = page.locator(".cam-batch-row", has_text="UI U15 Mon Wed")
                ...
                form = page.locator("#camBatchCoachForm")
                ...
                _wait_editor_gone(page, "#camBatchCoachForm")
                batch_row = page.locator(".cam-batch-row", has_text="UI U15 Mon Wed")
                ...
                for player in (p1, p2):
                    ...
                    form = page.locator("#camBatchPlayerForm")
                    form.locator('[name="batch_id"]').select_option(label="UI U15 Mon Wed")
                    ...
                    _wait_editor_gone(page, "#camBatchPlayerForm")
                batch_row = page.locator(".cam-batch-row", has_text="UI U15 Mon Wed")
                ...
                page.get_by_role("button", name="Add Player").last.click()
                _wait_editor_gone(page, "#camBatchPlayerForm")
                waitlist_row = page.locator(".cam-batch-membership-row", has_text=p3["name"])
                ...
                form = page.locator("#camBatchScheduleForm")
                form.locator('[name="batch_id"]').select_option(label="UI U15 Mon Wed")
                ...
                _wait_editor_gone(page, "#camBatchScheduleForm")
                ui_batch_sessions = page.locator(".cam-session-row").filter(has_text="UI U15 Mon Wed")
                ...
                form = page.locator("#camMakeupSessionForm")
                ...
                _wait_editor_gone(page, "#camMakeupSessionForm")
                ...
                form = page.locator("#camPrivateSessionForm")
                ...
                _wait_editor_gone(page, "#camPrivateSessionForm")
                ...
                workload = _json_request("GET", f"/api/cam/coaches/{coach1['id']}/workload")
                ...
                page.screenshot(path="test-results/cam-batches-ui-failure.png", full_page=True)
                raise
            finally:
                browser.close()
    finally:
