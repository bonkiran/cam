...
def test_owner_browser_gets_session_aware_management_parent_does_not():
    ...
    try:
        ...
        _json_request("PUT", "/api/academy/profile", {"name": "RBAC UI Academy"})
        ...
        with sync_playwright() as playwright:
            ...
            try:
                ...
                owner_page.goto(f"{BASE_URL}/#academy?tab=programs", wait_until="domcontentloaded")
                ...
                anonymous_page.goto(f"{BASE_URL}/#academy?tab=programs", wait_until="domcontentloaded")
