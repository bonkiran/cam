...
def test_coaches_ui_end_to_end():
    ...
    try:
        ...
        _json_request("PUT", "/api/cam/profile", {"name": "Coaches UI Academy"})
        player = _json_request("POST", "/api/cam/players", {"name": "UI Coach Player", "status": "active"})
        ...
        with sync_playwright() as playwright:
            ...
            try:
                ...
                form = page.locator("#camCoachForm")
                ...
                coach_row = page.locator(".cam-coach-row", has_text="Meera Patel")
                ...
                assignment_form = page.locator("#camCoachAssignmentForm")
                ...
                assignment_row = page.locator(".cam-coach-assignment-row", has_text="Meera Patel")
                ...
                end_form = page.locator("#camEndCoachAssignmentForm")
                ...
                page.screenshot(path="test-results/cam-coaches-ui-failure.png", full_page=True)
                raise
            finally:
                browser.close()
    finally:
