...
def test_academy_player_guardian_end_to_end():
    ...
    academy_response = client.put("/api/academy/profile", json=academy_payload)
    assert academy_response.status_code == 200
    assert academy_response.json()["profile"]["name"] == "Test Cricket Academy"

    profile_response = client.get("/api/academy/profile")
    ...
    create_response = client.post("/api/academy/players", json=player_payload)
    ...
    detail_response = client.get(f"/api/academy/players/{player_id}")
    ...
    update_response = client.put(f"/api/academy/players/{player_id}", json=player_payload)
    ...
    directory_response = client.get("/api/academy/players")
