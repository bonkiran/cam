...
def test_tournament_registration_ui_end_to_end():
    ...
    try:
        ...
        _json_request("PUT", "/api/academy/profile", {"name": "Tournament UI Academy"})
        team = _json_request("POST", "/api/academy/teams", {"name": "UI Tournament U15 XI", "age_group": "U15", "status": "active"})
        ...
        with sync_playwright() as playwright:
            ...
            try:
                ...
                form = page.locator("#academyTournamentForm")
                ...
                tournament_row = page.locator(".academy-tournament-row", has_text="UI Southeast Junior Cup")
                ...
                entry_form = page.locator("#academyTournamentEntryForm")
                ...
                entry_row = page.locator(".academy-tournament-entry-row", has_text="UI Tournament U15 XI")
                ...
                expect(page.locator(".academy-programs-note")).to_contain_text("Fee linkage deferred")
            except Exception:
                Path("test-results").mkdir(exist_ok=True)
                page.screenshot(path="test-results/academy-tournaments-ui-failure.png", full_page=True)
                raise
            finally:
                browser.close()
    finally:
