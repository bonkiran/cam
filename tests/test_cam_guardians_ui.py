...
def _create_player(page, name: str):
    ...
    expect(page.locator("#camPlayerForm")).to_have_count(0, timeout=10000)
    row = page.locator(".cam-player-row", has_text=name)
    ...
    try:
        ...
        with sync_playwright() as playwright:
            ...
            try:
                ...
                expect(page.locator("#camPlayerForm")).to_be_visible()
                ...
                row_a = page.locator(".cam-player-row", has_text=player_a)
                ...
                page.get_by_role("button", name="Save Changes").click()
                _wait_for_save(page)
                row_b = page.locator(".cam-player-row", has_text=player_b)
                ...
                page.screenshot(path="test-results/cam-guardian-ui-failure.png", full_page=True)
                raise
            finally:
                browser.close()
    finally:
