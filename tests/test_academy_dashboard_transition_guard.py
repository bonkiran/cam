...
def test_legacy_academy_overview_is_guarded_before_dashboard_v4_loads():
    ...
    dashboard_v4_index = html.index('/static/academy_dashboard_v4.js?v=1')
    ...
    assert ":scope > .academy-hero" in guard
    assert ":scope > .academy-stats" in guard
    assert ":scope > .academy-dashboard-grid" in guard
