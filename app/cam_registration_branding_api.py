...
from .cam_registration_api import _invite_for_token, _require_sender
from .database import fetch_one


router = APIRouter(tags=["cam-registration-branding"])
...
@router.get("/api/cam/registration/branding")
