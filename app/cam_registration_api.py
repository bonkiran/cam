...
@router.get("/api/cam/registration/invites")
...
@router.get("/api/cam/registration/summary")
...
@router.post("/api/cam/registration/invites", status_code=201)
...
@router.post("/api/cam/registration/invites/{invite_id}/sent")
...
@router.post("/api/cam/registration/invites/{invite_id}/resend")
...
@router.post("/api/cam/registration/invites/{invite_id}/cancel")
...
@router.get("/api/cam/registration/applications/{application_id}")
def registration_application(application_id: int, _: dict = Depends(_require_admin)):
    return _application(application_id)


@router.post("/api/cam/registration/applications/{application_id}/review")
