...
from .academy_enrollment_api import DOCUMENT_ROOT, _enrollment, _enrollment_for_token
from .academy_registration_api import _require_admin
from .database import connection, fetch_all, fetch_one

router = APIRouter(tags=["academy-enrollment-completion"])
...
@router.get("/api/academy/enrollments/completed")
