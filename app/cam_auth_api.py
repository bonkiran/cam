...
router = APIRouter(tags=["cam-access"])
...
@router.get("/api/cam/access/roles")
...
@router.get("/api/cam/access/reference")
...
@router.get("/api/cam/access/users")
...
@router.post("/api/cam/access/users", status_code=201)
...
@router.put("/api/cam/access/users/{user_id}")
...
@router.post("/api/cam/access/users/{user_id}/password", status_code=204)
...
@router.get("/api/cam/access/audit")
